...
#define NCCL_NET_HANDLE_MAXSIZE 1024
...
typedef struct {
  ...
  /**
   * @brief Performs an asynchronous broadcast operation on the collective group.
   * 
   * May return `request == NULL` if the call cannot be performed (or would block).
   */
  ncclResult_t (*broadcast)(void* collComm, void* sendData, void* recvData, int count, int root,
      ncclDataType_t dataType, void* sendMhandle, void* recvMhandle, void** request);

  /** 
   * @brief Performs an asynchronous allreduce operation on the collective group.
   * 
   * May return `request == NULL` if the call cannot be performed (or would block).
   */
  ...
  /**
   * @brief Performs an asynchronous allgather operation on the collective group.
   * 
   * May return request == NULL if the call cannot be performed (or would block).
   */
  ncclResult_t (*iallgather)(void* collComm, void* sendData, void* recvData, int count,
      ncclDataType_t dataType, void* sendMhandle, void* recvMhandle, void** request);
